...
from src.components.ai_conversation_client.cli import display_metrics, format_ai_response, main
...
class TestCliCommands:
    ...
    def test_models_command(self, mock_cerebras_client):
        ...
        with patch.object(sys, 'argv', test_args), \
            ...
            assert e.value.code != 1  # Should exit successfully
    ...
    def test_metrics_command(self, mock_cerebras_client):
    ...
    def test_export_command(self, mock_cerebras_client):
    ...
    def test_summarize_command(self, mock_cerebras_client):
    ...
    def test_missing_api_key(self, mock_cerebras_client):
    ...
    def test_session_not_found(self, mock_cerebras_client):
